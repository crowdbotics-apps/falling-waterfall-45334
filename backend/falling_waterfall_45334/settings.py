"""
Django settings for falling_waterfall_45334 project.
...
ROOT_URLCONF = 'falling_waterfall_45334.urls'
...
WSGI_APPLICATION = 'falling_waterfall_45334.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_waterfall_45334 API",
    "DESCRIPTION": "API documentation for falling_waterfall_45334 App",
    "VERSION": "v1",
}
